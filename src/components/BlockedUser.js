        ...
        <div className='overflow-y-auto h-[368px] scroll-smooth last:border-0'>       
            <div className='flex items-center gap-x-3.5 w-[95%] pb-3.5 border-b border-black/[0.25] mb-3.5'>
                ...
                <div className='w-[50%]'>
                    ...
                    <p className='font-Poppins font-semibold font-medium text-ptag/[0.75] text-sm'>Today, 8:56pm</p>
                </div>
                <div className='flex justify-end w-[30%]'>
                    <button className='px-[9px] py-[5px] bg-button font-semibold font-Poppins text-[20px] text-white rounded-[5px]'>UnBlock</button> 
                </div>
            </div> 
            <div className='flex items-center gap-x-3.5 w-[95%] pb-3.5 border-b border-black/[0.25] mb-3.5'>
                <div className='w-[20%]'>
